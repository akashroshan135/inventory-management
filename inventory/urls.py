...
urlpatterns = [
    ...
    path('inventory/<pk>/edit-stock', views.StockUpdateView.as_view(), name = 'edit-stock'),        # the 'StockUpdateView' class in the views.py is rendered as view is called when localhost is called
]